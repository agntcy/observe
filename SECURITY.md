...
The `observe` maintainers take all security issues in the project
seriously. Thank you for improving the security of `AGNTCY observe`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

The `observe` repository leverages GitHub's private vulnerability reporting.
